...
public class Timeline extends Weibo {
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getFriendsTimeline() throws WeiboException {
		return client.get(
				WeiboConfig.getValue("baseURL")
						+ "statuses/friends_timeline.json", access_token).asJSONObject();
...
//	}
	public JSONObject getFriendsTimeline(Map<String, String> map)
			throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return client.get(
				WeiboConfig.getValue("baseURL")
						+ "statuses/friends_timeline.json", parList, access_token).asJSONObject();
	}
